...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| hi-em-full-v3.3.3-4 (v3334_r1) | seg: α=100, λ=10, cos=0.9, β=0.25, rnn_train_steps=3 · mem: k_top=3, k_turn=5 · override: cos_threshold=0.9, alpha=100, beta=0.25, pe_threshold=0.5, rnn_train_steps=3 | 0.253 | 0.134 | 0.109 | 0.061 | 0.900 | 0.036 | 0.641 | 0.535 | 0.423 | 0.0269 | 0.960 | 0.045 | 29.5 | 21.2 | 19.0 | 69 | 28 | 256.7 | 9.65 | 1.52 | 8m 13s |
| hi-em-full-v3.3.3-4 (v3334_r2) | seg: α=100, λ=10, cos=0.9, β=0.25, rnn_train_steps=3 · mem: k_top=3, k_turn=5 · override: cos_threshold=0.9, alpha=100, beta=0.25, pe_threshold=0.5, rnn_train_steps=3, seed=43 | 0.257 | 0.156 | 0.107 | 0.071 | 0.900 | 0.030 | 0.628 | 0.528 | 0.399 | 0.0259 | 0.961 | 0.038 | 25.3 | 19.5 | 17.5 | 39 | 28 | 43.8 | 9.89 | 1.63 | 9m 11s |
| hi-em-full-v3.3.3-4 (v3334_r3) | seg: α=100, λ=10, cos=0.9, β=0.25, rnn_train_steps=3 · mem: k_top=3, k_turn=5 · override: cos_threshold=0.9, alpha=100, beta=0.25, pe_threshold=0.5, rnn_train_steps=3, seed=44 | 0.256 | 0.135 | 0.092 | 0.076 | 0.925 | 0.027 | 0.647 | 0.538 | 0.411 | 0.0252 | 0.945 | 0.071 | 26.0 | 20.7 | 18.9 | 33 | 28 | 45.5 | 9.89 | 1.77 | 8m 49s |
| hi-em-full-v3.3.3 (v333_r1) | seg: α=100, λ=10, cos=0.9, β=0.25, rnn_train_steps=3 · mem: k_top=3, k_turn=5 · override: cos_threshold=0.9, alpha=100, beta=0.25, pe_threshold=0.5, rnn_train_steps=3 | 0.256 | 0.154 | 0.072 | 0.054 | 0.950 | 0.028 | 0.333 | 0.252 | 0.180 | 0.0029 | 0.927 | 0.071 | 28.9 | 21.4 | 18.3 | 48 | 32 | 88.2 | 9.77 | 1.97 | 8m 13s |
| hi-em-full-v3.3.3 (v333_r2) | seg: α=100, λ=10, cos=0.9, β=0.25, rnn_train_steps=3 · mem: k_top=3, k_turn=5 · override: cos_threshold=0.9, alpha=100, beta=0.25, pe_threshold=0.5, rnn_train_steps=3, seed=43 | 0.254 | 0.138 | 0.068 | 0.042 | 0.975 | 0.025 | 0.308 | 0.230 | 0.225 | 0.0030 | 0.951 | 0.032 | 25.8 | 18.6 | 17.8 | 37 | 25 | 52.6 | 10.00 | 1.91 | 9m 15s |
| hi-em-full-v3.3.3 (v333_r3) | seg: α=100, λ=10, cos=0.9, β=0.25, rnn_train_steps=3 · mem: k_top=3, k_turn=5 · override: cos_threshold=0.9, alpha=100, beta=0.25, pe_threshold=0.5, rnn_train_steps=3, seed=44 | 0.254 | 0.139 | 0.057 | 0.051 | 0.975 | 0.026 | 0.327 | 0.240 | 0.195 | 0.0029 | 0.941 | 0.058 | 25.6 | 20.8 | 18.0 | 33 | 29 | 33.3 | 9.88 | 1.98 | 8m 47s |
...
- **방법**:
  - `hi-em-full-v3.3.3` (baseline) × 3 seeds (42/43/44)
  - `hi-em-full-v3.3.3-4` × 3 seeds (42/43/44)
...
6. **dormant_ev_rate 0.94+ 의 baseline value 자체**: 모든 hi-em-full method 에서 0.93~0.96 으로 거의 균일. importance policy 가 아닌 *segmentation 단계에서 evidence-bearing turn 을 다른 topic 에 묶어버리는 가능성* 도 배제 못 함 (segmentation level cause).
