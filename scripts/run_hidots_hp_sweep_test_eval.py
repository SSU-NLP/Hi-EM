...
The original sweep (`run_hidots_hp_sweep.py`) computed Score on the
...
from run_hidots_hp_sweep import (  # noqa: E402
    load_dialogs, load_embs, split_frac, eval_on,
)

DEFAULT_HP = dict(delta_star=0.5594, ctx_window=2, ctx_decay=0.7, ctx_blend_a=0.5)

SRC_NAME = "2026-05-22_hidots_hp_sweep"
DST_NAME = "2026-05-25_hidots_hp_sweep_test_eval"
...
def main() -> None:
    ...
    # build test sets (same as run_hidots_hp_sweep main)
