...
`outputs/experiments/2026-05-25_hidots_mra_sweep/` · 2026-05-25
...
- Script: `scripts/run_hidots_mra_sweep_oracle.py`
- 데이터: `sweep.json` (90 rows, 각 row 에 oracle/best-px Score per bench + δ\*).
- 비교 (4D uniform δ\* sweep): `2026-05-22_hidots_hp_sweep/sweep_results.json` + `2026-05-25_hidots_hp_sweep_test_eval/sweep_test_scores.json` (default rank 1 / 630 under uniform setup).
