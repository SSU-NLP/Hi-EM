...
Experimental fork of v4.1.1 (``sem_core_v411.HiEMSegmenterV411``). v4.1.1
...
class HiEMSegmenterV432Exp(HiEMSegmenterV411):
    ...
    def assign(self, s):  # noqa: D401
        ...
        raise NotImplementedError(
            "HiEMSegmenterV432Exp requires assign_pair(s_topic, delta_model_t); "
