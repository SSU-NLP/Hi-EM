...
Experimental fork of v4.1.1 (``sem_core_v411.HiEMSegmenterV411``) using
...
class HiEMSegmenterV423Exp(HiEMSegmenterV411):
    ...
    def assign(self, s):  # noqa: D401
        ...
        raise NotImplementedError(
            "HiEMSegmenterV423Exp requires assign_pair(s_topic, s_flow); "
