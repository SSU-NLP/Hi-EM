...
Hi-EM-full-v3.1 (model name: ``hi-em-full-v3.1.1``) replaces the diagonal
Gaussian likelihood of the v2 :class:`hi_em.topic.Topic` with a
...
This file is **only** used when ``HiEM(version="v3.1.1")``. v2 paths
import ``hi_em.topic.Topic`` unchanged. v3.2 (cosine prediction
error) lives in ``hi_em.topic_optimize_pe``.
"""
