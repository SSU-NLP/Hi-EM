...
subtitle: "처음 보는 사람용 · src/hi_em/hi_ontop.py — HiOnTop · 2026-05-22"
---
...
>
> **이 문서엔 안 도는 코드가 없다.** Hi-OnTop 는 Hi-EM v4.1.x 라인을
...
**Hi-OnTop = Hi-EM v4.1.x 라인이 경험적으로 *환원되는* 정직한 최소
온라인 segmenter.**
...
`hi_ontop.py` [L134](../../src/hi_em/hi_ontop.py#L134)
...
`hi_ontop.py` [L145](../../src/hi_em/hi_ontop.py#L145)
...
`hi_ontop.py` [L161](../../src/hi_em/hi_ontop.py#L161)
...
`hi_ontop.py` [L190–197](../../src/hi_em/hi_ontop.py#L190) — `assign` 이
...
`hi_ontop.py` [L188, 199–216](../../src/hi_em/hi_ontop.py#L188) — 같은
`assign` 호출의 마무리.
...
히스토그램, [hi_ontop.py:233](../../src/hi_em/hi_ontop.py#L233)):
...
- §2 동작 순서는 `HiOnTop.assign` ([hi_ontop.py:180](../../src/hi_em/hi_ontop.py#L180))
...
- graded score = δ_eff/δ*, turn 0 = 0.0, band 경계(0.7/1.0/1.3) 코드
  ([hi_ontop.py:233](../../src/hi_em/hi_ontop.py#L233))와 일치.
