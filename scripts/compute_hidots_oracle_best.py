#!/usr/bin/env python3
"""Hi-DoTS per-metric (Pk/WD/F1/Score) — oracle + best per (encoder, bench).
...
def main() -> None:
    ...
    ap.add_argument("--name", default="2026-05-24_hidots_oracle_best")
    args = ap.parse_args()
    ...
    L = ["# Hi-DoTS oracle / best per-metric (superdialseg_data, NLTK Pk/WD)",
         "",
    ...
    L += ["## 한계",
          ...
          "- HP m/ρ/a fixed (Hi-DoTS default), encoder 만 교체."]
