# REPORT — TIAGE test: 구현된 전 hi-em-full 계열 segmentation 비교 (12 method × 3 seed)

experiment: `2026-05-17_tiage_all_hiem_full`
generated: 2026-05-17 (DTS 전환 후 첫 확정 측정 / branch `dts`)
path: `outputs/experiments/2026-05-17_tiage_all_hiem_full/`
...
- **목적**: QA→DTS task 전환(decision-log 2026-05-17) 후, 이제까지 구현한
  모든 hi-em-full segmenter 가 **default HP 에서 TIAGE topic-shift 를
