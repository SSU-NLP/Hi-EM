...
- Hi-DoTS HP: m=2, ρ=0.7, a=0.5, 인코더 minilm (sentence-transformers/all-MiniLM-L6-v2).
...
δ* — p80=0.7762 · best-Score=0.7669 (train split (300/300 dial))
...
| **Ours (p80)** | 0.4301 | 0.4777 | 0.3356 | **0.4409** | 0.0964 |
| Ours (best-Score)‡ref | 0.4315 | 0.4905 | 0.3567 | 0.4478 | 0.0857 |

## dialseg711  (test 711 dialog)

δ* — p80=0.7813 · best-Score=0.7975 (‡ train split 부재 → test 보정 (in-domain upper-bound))
...
| CSM-style | _대기_ | _대기_ | _대기_ | _대기_ | _대기_ |
| **Ours (p80)** | 0.3278 | 0.3682 | 0.5300 | **0.5910** | 0.0634 |
| Ours (best-Score)‡ref | 0.3176 | 0.3468 | 0.5231 | 0.5954 | 0.0619 |

## superseg  (test 1322 dialog)

δ* — p80=0.7947 · best-Score=0.6042 (train split (600/6948 dial subsample))
...
| CSM-style | _대기_ | _대기_ | _대기_ | _대기_ | _대기_ |
| **Ours (p80)** | 0.5400 | 0.5604 | 0.2751 | **0.3625** | 0.1185 |
| Ours (best-Score)‡ref | 0.4850 | 0.6843 | 0.4348 | 0.4251 | 0.0524 |
