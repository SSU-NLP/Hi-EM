"""Hi-DoTS — Hi-EM Dialogue Topic Segmenter (reduced form).

Hi-DoTS is the honest, minimal online dialogue topic segmenter that the
Hi-EM v4.1.x line empirically collapses to. An audit (2026-05-22) of
``sem_core_v413.py`` (= ``HiEMSegmenterV413(HiEMSegmenterV411)``) showed
...
Relationship to SEM
-------------------
Hi-DoTS is a minimal online realization of SEM's core intuition — an
