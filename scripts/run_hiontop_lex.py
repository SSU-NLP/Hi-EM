...
Hi-OnTop-Lex (``src/hi_em/hi_ontop_lex.py``) adds a TextTiling-style
...
from hi_em.hi_ontop_lex import HiOnTopLex  # noqa: E402
...
def write_report(exp_dir: Path, results: dict, summary: dict) -> None:
    ...
    L += [
        ...
        "- **모델**: `src/hi_em/hi_ontop_lex.py` `HiOnTopLex`. "
