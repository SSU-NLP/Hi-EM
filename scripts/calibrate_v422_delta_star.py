...
``sentence-transformers/multi-qa-mpnet-base-dot-v1`` (Hi-EM local
...
def main() -> None:
    ...
    lines += [
        ...
        "δ* (Hi-EM `seg_pred_v411(..., encoder='aws-ai/dse-bert-base')` "
        "via HIEM_EMBEDDING_BACKEND=local). Compare against v4.1.1 "
