...
- **2026-04-26-baseline/** (2026-04-26): Phase 4 reference baseline. Hi-EM persistence + nothink + full-500 LongMemEval = 0.562 overall — 4 method 중 꼴찌 (sliding/full/RAG 모두 우위). multi-session 0.23 / knowledge 0.51. → **Phase 4 종료, baseline 으로 동결, 재실행 금지**. 자세히는 `2026-04-26-baseline/README.md`.
