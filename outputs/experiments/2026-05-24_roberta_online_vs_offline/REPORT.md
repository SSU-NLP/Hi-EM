...
setup: ckpt = `/home/namchailin/Hi-EM/methods/RoBERTa/_roberta_unzip/roberta_seg_out/roberta_supervised/model`, device cpu, per-bench limit = 50 dial (first-N deterministic, sliding_window={args.sliding_window}, max_utt_len={args.max_utt_len}).
