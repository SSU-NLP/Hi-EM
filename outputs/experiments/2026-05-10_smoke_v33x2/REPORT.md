...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| hi-em-full-v3.3.3-2 (smoke332) | seg: α=1, λ=10, cos=0.7, β=0.5, rnn_train_steps=1 · mem: k_top=3, k_turn=5 | 0.000 | 0.000 | - | 0.000 | - | 0.000 | - | - | - | - | - | - | - | - | - | - | 0.00 | - | 15s |
| hi-em-full-v3.3.4-2 (smoke342) | seg: α=1, λ=10, cos=0.7, β=0.5, rnn_train_steps=1 · mem: k_top=3, k_turn=5 | 0.000 | 0.000 | - | 0.000 | - | 0.000 | - | - | - | - | - | - | - | - | - | - | 0.00 | - | 14s |
