...
#          hi-em-full-v3.3.1, rag, rag-summary, rag-observation, sliding.
#
# Per-run STM top-K stats (T1/T2/T3 turn-counts) for hi-em-full-* methods are
# captured into <run_dir>/stm_topk.json + .rounds.jsonl via the
# HIEM_STM_TOPK_STATS_PATH env var. RAG / sliding do not emit these.
#
...
# Hi-EM lineage (RNN-free → RNN, in chronological order).
run_one locomo hi-em-full-v1       benchmarks/locomo/data/locomo10.json
run_one locomo hi-em-full-v3.1.1   benchmarks/locomo/data/locomo10.json
run_one locomo hi-em-full-v3.2.1   benchmarks/locomo/data/locomo10.json
run_one locomo hi-em-full-v3.3.1   benchmarks/locomo/data/locomo10.json
...
rows = [
    ("hi-em-full-v1", "locomo"),
    ("hi-em-full-v3.1.1", "locomo"),
    ("hi-em-full-v3.2.1", "locomo"),
    ("hi-em-full-v3.3.1", "locomo"),
    ("rag", "locomo"),
    ("rag-summary", "locomo"),
