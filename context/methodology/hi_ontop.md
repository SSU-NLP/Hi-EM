# Hi-OnTop — Hi-EM Dialogue Topic Segmenter (reduced-form main model)

`src/hi_em/hi_ontop.py` · 2026-05-22 신설 (v4.1.x dead-code audit 결과)
...
- **2026-05-22 신설** — v4.1.x dead-code audit(commit `326b86b`)으로
  `src/hi_em/hi_ontop.py` `HiOnTop` 도입. v4.1.3 와 output parity 검증
