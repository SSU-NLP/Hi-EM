#!/usr/bin/env python3
"""Hi-DoTS p70/p75/p80 per-metric for MiniLM-int8 (3 benches).

dts_result.md 의 Online Ours 행 보완 — MPNet 의 p70/p75/p80 와 같은 자리에
MiniLM-int8 percentile family 행도 추가하기 위함.
...
def main() -> None:
    out_dir = REPO / "outputs" / "experiments" / "2026-05-24_hidots_minilm_int8_percentile"
    ...
    L = ["# Hi-DoTS p70/p75/p80 per-metric (MiniLM-int8, superdialseg_data)",
         "",
