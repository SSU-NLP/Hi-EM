#!/usr/bin/env python3
"""Hi-DoTS full HP sweep — all 4 hyper-parameters, single grid.

Hi-DoTS (``src/hi_em/hi_dots.py``) has exactly 4 hyper-parameters, all live
...
def main() -> None:
    ...
    ap.add_argument("--name", default="2026-05-22_hidots_hp_sweep")
    args = ap.parse_args()
    ...
    # REPORT
    L = ["# Hi-DoTS full HP sweep — all 4 HPs", "",
         "Hi-DoTS has exactly 4 hyper-parameters, all live. Single grid sweep.",
