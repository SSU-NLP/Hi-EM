...
def _factory_v335(dim):
    return HiEMSegmenterV335(dim=dim, alpha=1.0, lmda=10.0)


def _factory_v336(dim):
    return HiEMSegmenterV336(dim=dim, alpha=1.0, lmda=10.0)


def _factory_v337(dim):
    return HiEMSegmenterV337(dim=dim, alpha=1.0, lmda=10.0)


def _factory_v338(dim):
    return HiEMSegmenterV338(dim=dim, alpha=1.0, lmda=10.0)
